...
Variables cannot be assigned twice
`=` operator
`print()` function

A2. x is 15 and y is 15
...
Knowledge Components:
String repetition adds space
`" "` constructor
`=` operator

A4. "Glib jocks quiz nymph to vex dwarf.asdf"
...
A4.  TRUE on one line and FALSE on the next
